...
| [0053](./0053-a-content-browser-searches-everything-loaded-and-groups-by-what-the-system-declares.md) | A content browser searches everything loaded, and groups it by what the system declares | Proposed (builds on 0003, 0012, 0049, 0052) |
