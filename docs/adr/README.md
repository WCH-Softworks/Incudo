...
| [0052](./0052-a-source-that-refers-to-content-no-enabled-source-has-is-reported-and-never-blocked.md) | A source that refers to content no enabled source has is reported, and never blocked | Accepted (builds on 0005, 0028, 0051; constrains 0007) |
| [0053](./0053-a-content-browser-searches-everything-loaded-and-groups-by-what-the-system-declares.md) | A content browser searches everything loaded, and groups it by what the system declares | Accepted (builds on 0003, 0012, 0049, 0052) |
| [0054](./0054-when-two-sources-define-the-same-id-the-later-one-in-the-list-is-used-and-the-list-says-so.md) | When two sources define the same id, the later one in the list is used, and the list says so | Proposed (builds on 0005, 0012, 0028, 0052) |
