...
| [0044](./0044-hit-points-follow-the-method-the-character-uses.md) | Hit points follow the method the character uses, and each class keeps its own dice | Proposed (amends 0019; touches 0008; builds on 0015, 0016, 0018, 0022, 0036) |
