...
| [0049](./0049-a-character-records-which-publications-it-is-offered-and-it-narrows-offers-only.md) | A character records which publications it is offered, and that narrows offers only | Proposed (builds on 0012, 0028) |
