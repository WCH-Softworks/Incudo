...
| [0045](./0045-a-class-split-is-one-input-and-an-unmet-ability-score-minimum-is-a-flag.md) | A class split is one input, and an unmet ability score minimum is a flag, not a gate | Proposed (amends 0036; builds on 0012, 0015, 0017) |
